...
ADAPT_DIR = os.path.abspath(os.path.dirname(__file__))
APP_DIR = os.path.abspath(os.path.join(ADAPT_DIR, "..", "..", ".."))
...
ACTIVE_MODEL_VERSION = os.environ.get("SEED_MODEL_VERSION", "selected_2019")
ACTIVE_MODEL_ROOT = os.path.join(STREAMLIT_MODEL_ARTIFACTS_DIR, ACTIVE_MODEL_VERSION)
MODEL_GRID_PATH = os.environ.get(
    "MODEL_GRID_PATH",
    os.path.join(REPO_ROOT, "checkpoints", "grid", "model_grid.npz"),
)
